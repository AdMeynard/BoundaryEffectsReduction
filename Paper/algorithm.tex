...
Establishing a dynamical model means determining the relation linking $\bY$ to $\bX$; that is, finding a function $f$ so that
\begin{equation}
\bY = f(\bX)\ .
...
Determining the forecasting amounts to estimating the unknown matrix $\bA$. Indeed, let $\tilde\bA$ denotes the estimate of $\bA$. 
%
