...
Then, we consider a second respiratory signal that contains not only the respiratory cycle, but also a cardiac component known as the cardiogenic artifact~\cite{Smith94recognition}. The top of Fig.~\ref{fig:resp.2} shows an excerpt of the measured signal, as well as a 10-second-long {\sf SigExt} extension. Below, the simultaneously recorded ECG signal emphasizes the coincidences between the cardiogenic artifact of the respiratory signal and the ECG.
