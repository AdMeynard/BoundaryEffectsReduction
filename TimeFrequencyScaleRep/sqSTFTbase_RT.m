function [tfr, tfrsq, tfrtic] = sqSTFTbase_RT(x, lowFreq, highFreq, alpha, tDS, LL, h, Dh, Smooth)
% SQSTFTBASE_RT Synchrosqueezing of the STFT
% Usage: 
% 	[tfr, tfrrs, tfrtic] = sqSTFTbase_RT(x, lowFreq, highFreq, alpha, tDS, LL, h, Dh, Smooth)
%
% Input:
%	x     : analysed signal.
