function [tfr, tfrsq, tfrsq2nd, tfrtic] = sqSTFTbase2nd(x, lowFreq, highFreq, alpha, tDS, h, Dh, DDh)
% SQSTFTBASE2ND Second-order Synchrosqueezing of the STFT
% Usage: 
% 	[tfr, tfrrs, tfrtic] = sqSTFTbase2nd(x, lowFreq, highFreq, alpha, tDS, h, Dh, DDh)
%
% Input:
%	x     : analysed signal.
...
%   DDh   : second-order differentiation of H
% 
% Output:
%	tfr   : STFT
%	tfrrs : synchrosqueezed STFT
%	tfrrs2nd : second-order synchrosqueezed STFT
