function [tfr, tfrsq, tfrtic] = sqSTFT_RT(x, lowFreq, highFreq, alpha, hop, WinLen, LL, dim, supp, Second, Smooth)
% SQSTFT_RT Synchrosqueezing of the STFT using Hermite window
% Usage: 
% 	[tfr, tfrsq, tfrtic] = sqSTFT_RT(x, lowFreq, highFreq, alpha, hop, WinLen, LL, dim, supp, Second, Smooth)
%
% Input:
