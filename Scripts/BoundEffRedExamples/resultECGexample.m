...
%% Load results
load('../../Results/resultECGexample')

dataTBATS = table2array( readtable('../../Results/ECG_TBATS.csv') ) ;
...
[~, SSTxxGPR, ~, ~] = ConceFT_sqSTFT_C(xxGPR, basicTF.fmin, basicTF.fmax,...
            basicTF.df, basicTF.hop, basicTF.win, 1, 10, 1, 0, 0) ;
% On the estimated extended signal 
[~, SSTxxTBATS, ~, ~] = ConceFT_sqSTFT_C(xxTBATS, basicTF.fmin, basicTF.fmax,...
            basicTF.df, basicTF.hop, basicTF.win, 1, 10, 1, 0, 0) ;
...
OTDTBATS = slicedOT(tfrsqTBATSw, tfrsqTRUEw) ;
