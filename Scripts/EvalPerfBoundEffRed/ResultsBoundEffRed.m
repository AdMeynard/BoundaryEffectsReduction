...
fprintf('|  LSE extension   | %.3f | %.3f | %.3f |\n', mean(OTD.sst.LSE./OTD.sst.S),mean(OTD.stft.LSE./OTD.stft.S),mean(OTD.conceft.LSE./OTD.rs.S))
fprintf('|  Symmetrization  | %.3f | %.3f | %.3f |\n', mean(OTD.sst.SYM./OTD.sst.S),mean(OTD.stft.SYM./OTD.stft.S),mean(OTD.conceft.SYM./OTD.rs.S))
fprintf('|  EDMD extension  | %.3f | %.3f | %.3f |\n', mean(OTD.sst.EDMD./OTD.sst.S),mean(OTD.stft.EDMD./OTD.stft.S),mean(OTD.conceft.EDMD./OTD.rs.S))
fprintf('|  GPR extension   | %.3f | %.3f | %.3f |\n', mean(OTD.sst.GPR./OTD.sst.S),mean(OTD.stft.GPR./OTD.stft.S),mean(OTD.conceft.GPR./OTD.rs.S))
