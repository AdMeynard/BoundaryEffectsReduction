...
fprintf('|________________|_____________|_________|_______|________________|\n\n')
...
fprintf('|----------------|---------|-------|\n')
fprintf('|      SigExt    |  %.3f  | %.3f |\n', mean(OTD.STFT.LSE./OTD.STFT.S), std(OTD.STFT.LSE./OTD.STFT.S)) % time divided by 2 because 2 extensions are operated in CompPerfAHM
