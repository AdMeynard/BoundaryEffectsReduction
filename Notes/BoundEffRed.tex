...
\usepackage{hyperref}
\usepackage{mathpazo}
\usepackage[left=90pt,right=90pt,top=70pt,bottom=70pt]{geometry}
...
\begin{figure}
\includegraphics[width=.49\textwidth]{SSTintro.eps}
\includegraphics[width=.49\textwidth]{zoomSSTintro.eps}
