...
\title{An Efficient Forecasting Approach for the Reduction of Boundary Effects in Time-Frequency Representations}
...
%The purpose of this paper is providing a fast algorithm allowing to tackle boundary effects and limit the disruptions it may cause on the signals representations based on windowing. 
