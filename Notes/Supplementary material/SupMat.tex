...
\label{eq:g2g1}
\end{equation}
Besides, using the results of the Isserlis' theorem~\cite{Isserlis16formula} to express fourth-order moments of a Gaussian random vector as a function of its second-order moments, we bound $\left|\bE\{\bg_2[r]\bg_2[r']\}\right|$ as follows:
\begin{align}
\nonumber
